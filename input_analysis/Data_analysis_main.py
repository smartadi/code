...
axs[0].plot(tempn[:10,:1000].T)
axs[0].set(xlabel='time',ylabel = 'wf_normal')
axs[1].plot(motions[:1000])
axs[1].set(xlabel='time',ylabel = 'motions')
axs[2].plot(temp[:10,:1000].T)
axs[2].set(xlabel='time',ylabel = 'wf')
axs[3].plot(motTempfn[:1000])
axs[3].set(xlabel='time',ylabel = 'wf')
plt.show()
...
fig, axs = plt.subplots(4,1,figsize=(9, 6))
fig.suptitle('Vertically stacked subplots')
axs[0].plot(tempn[:10,10000:12000].T)
axs[0].set(xlabel='time',ylabel = 'wf')
axs[1].plot(motions[10000:12000])
axs[1].set(xlabel='time',ylabel = 'wf')
axs[2].plot(temp[:10,10000:12000].T)
axs[2].set(xlabel='time',ylabel = 'wf')
axs[3].plot(motTempfn[10000:12000])
axs[3].set(xlabel='time',ylabel = 'wf')
plt.show()
...
axs[1].set(xlabel='time',ylabel = 'motions')
axs[2].plot(ortho_temp[:10,T:T+d].T)
axs[2].set(xlabel='time',ylabel = 'wf_ortho')
axs[3].plot(motTempfn[T:T+d,0:5])
axs[3].set(xlabel='time',ylabel = 'motion_svd')
axs[4].plot(motTempfn[T:T+d,0])
axs[4].set(xlabel='time',ylabel = 'motion_svd')
#plt.grid(axis = 'x')
plt.show()
...
# f = open('/home/mist/Documents/projects/Brain/code/SubspaceID/examples/freq.csv', "r")
# print(f.read())
...
axs[4].plot(ortho_temp[:10,T:T+d].T)
axs[4].set(xlabel='time',ylabel = 'discrete time eig')
plt.show()
