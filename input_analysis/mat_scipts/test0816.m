...
path = "/run/user/1000/gvfs/smb-share:server=sahale.biostr.washington.edu,share=data/Subjects/AB_0032/2024-08-16/1/img_bin";
...
fileID = fopen(path,'r');
A = fread(fileID,[560*560, 10006],'*uint16')';
