%
% Stochastic Subspace identification for stacked data on WF and NP 10k
% data-points 
...
data_r = data_r./vecnorm(data_r,1,2);

data_small  = data_r(1:1000,:);
...
%
  ...
  nn= 20
    ...
    [A,du1,C,du2,K,R,AUX] = subid_stable(data_small,[],i,nn,[],[],1);

  nn= 20 
    [Anp,du1,Cnp,du2,Knp,Rnp,AUX] = subid_stable(data_small(:,1:l/2),[],i,nn,AUX,'sv');
    [Awf,du1,Cwf,du2,Kwf,Rwf,AUX] = subid_stable(data_small(:,l/2+1:end),[],i,nn,AUX,'sv');
    
    %[A,du1,C,du2,K,R,AUX] = subid(data_r,[],i,nn,[],[],1);

    
    %[Asp,du1sp,Csp,du2sp,Ksp,Rsp,AUXsp] = subid_sparse2(data_sp,[],i,nn,AUX,'sv');
...
data_f = data_r(1:2000,1:l)';
data_fwf = data_r(1:2000,l/2+1:end)';
data_fnp = data_r(1:2000,1:l/2)';
% 
% x(:,1) = x0;
% x_wf = zeros(n2,T);
% x_np = zeros(n2,T);
...
for i=1:10
    subplot(2,5,i)
    plot(data_f(i,1:500),'k','Linewidth',3);hold on;
    
    if i<=l/2
        plot(y_np(i,1:500),'g','Linewidth',2);
    else
        plot(y_wf(i-l/2,1:500),'r','Linewidth',2);
    end
    plot(y(i,1:500),'b');
    title(num2str(i))
end
...
figure()
subplot(2,1,1)
plot(y(1,1500:1750),'k','Linewidth',2);hold on;
plot(y_np(1,1500:1750),'-k','Linewidth',1);hold on;
plot(data_f(1,1500:1750),'--k','Linewidth',1.5);hold on;

plot(y(2,1500:1750),'g','Linewidth',2);hold on;
plot(y_np(2,1500:1750),'-g','Linewidth',1);hold on;
plot(data_f(2,1500:1750),'--g','Linewidth',1.5);hold on;

plot(y(3,1500:1750),'b','Linewidth',2);hold on;
plot(y_np(3,1500:1750),'-b','Linewidth',1);hold on;
plot(data_f(3,1500:1750),'--b','Linewidth',1.5);hold on;

plot(y(4,1500:1750),'m','Linewidth',2);hold on;
plot(y_np(4,1500:1750),'-m','Linewidth',1);hold on;
plot(data_f(4,1500:1750),'--m','Linewidth',1.5);hold on;

plot(y(5,1500:1750),'r','Linewidth',2);hold on;
plot(y_np(5,1500:1750),'-r','Linewidth',1);hold on;
plot(data_f(5,1500:1750),'--r','Linewidth',1.5);hold on;
legend('Combined system','single system','measured')

subplot(2,1,2)
plot(y(6,1500:1750),'k','Linewidth',2);hold on;
plot(y_wf(1,1500:1750),'-k','Linewidth',1);hold on;
plot(data_f(6,1500:1750),'--k','Linewidth',1.5);hold on;

plot(y(7,1500:1750),'g','Linewidth',2);hold on;
plot(y_wf(2,1500:1750),'-g','Linewidth',1);hold on;
plot(data_f(7,1500:1750),'--g','Linewidth',1.5);hold on;

plot(y(8,1500:1750),'b','Linewidth',2);hold on;
plot(y_wf(3,1500:1750),'-b','Linewidth',1);hold on;
plot(data_f(8,1500:1750),'--b','Linewidth',1.5);hold on;

plot(y(9,1500:1750),'m','Linewidth',2);hold on;
plot(y_wf(4,1500:1750),'-m','Linewidth',1);hold on;
plot(data_f(9,1500:1750),'--m','Linewidth',1.5);hold on;

plot(y(10,1500:1750),'r','Linewidth',2);hold on;
plot(y_wf(5,1500:1750),'-r','Linewidth',1);hold on;
plot(data_f(10,1500:1750),'--r','Linewidth',1.5);hold on;
legend('Combined system','single system','measured')
%%

close all
figure()
plot(x(1,1500:1750),'k','Linewidth',2);hold on;
plot(x_np(1,1500:1750),'-k','Linewidth',1);hold on;
plot(x_wf(1,1500:1750),'-k','Linewidth',1);hold on;


plot(x(2,1500:1750),'g','Linewidth',2);hold on;
plot(x_np(2,1500:1750),'-g','Linewidth',1);hold on;
plot(x_wf(2,1500:1750),'-g','Linewidth',1);hold on;

plot(x(3,1500:1750),'b','Linewidth',2);hold on;
plot(x_np(3,1500:1750),'-b','Linewidth',1);hold on;
plot(x_wf(3,1500:1750),'-b','Linewidth',1);hold on;


plot(x(4,1500:1750),'m','Linewidth',2);hold on;
plot(x_np(4,1500:1750),'-m','Linewidth',1);hold on;
plot(x_wf(4,1500:1750),'-m','Linewidth',1);hold on;


plot(x(5,1500:1750),'r','Linewidth',2);hold on;
plot(x_np(5,1500:1750),'-r','Linewidth',1);hold on;
plot(x_wf(5,1500:1750),'-r','Linewidth',1);hold on;

legend('Combined system','NP','WF')